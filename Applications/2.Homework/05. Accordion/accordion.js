...
async function solution() {
    ...
    try {
        const responce = await fetch(`http://localhost:3030/jsonstore/advanced/articles/list`);
        ...
        async function more(e) {
            ...
            let text = ''
            try {
                const responce = await fetch(`http://localhost:3030/jsonstore/advanced/articles/details/${e.target.id}`);
