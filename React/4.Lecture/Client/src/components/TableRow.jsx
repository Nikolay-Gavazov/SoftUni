const TableRow = ({
    ...
    const onInfoClick = (event) =>{
        infoClickHandler(_id)
    }
    const onDeleteClick = ()=>{
        onDeleteClickHandler(true, _id);
    }
    const onEditClick = ()=>{
    ...
    return (
        <tr>
            ...
            <td className="actions">
                <button onClick={onEditClick} className="btn edit-btn" title="Edit">
                    <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fas"
                ...
                <button onClick={onDeleteClick} className="btn delete-btn" title="Delete">
                    <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fas"
                ...
                <button onClick={onInfoClick} className="btn info-btn" title="Info" >
                    <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fas"
