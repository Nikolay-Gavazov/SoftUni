...
describe('motorcycleRider', function() {
    ...
    it('check showroom wrong input', () => {
        assert.equal(motorcycleRider.motorcycleShowroom('AM', 100), "Invalid Information!")
        assert.equal(motorcycleRider.motorcycleShowroom([], 100), "Invalid Information!")
        assert.equal(motorcycleRider.motorcycleShowroom(['100', '200'], 1), "Invalid Information!")
        assert.equal(motorcycleRider.motorcycleShowroom(['200','300'],'1'), "Invalid Information!")  
        assert.equal(motorcycleRider.motorcycleShowroom(), "Invalid Information!")  
    })

    it('check showroom', () => {
        assert.equal(motorcycleRider.motorcycleShowroom(['100', '200'], 100), "There are 1 available motorcycles matching your criteria!")
        assert.equal(motorcycleRider.motorcycleShowroom(['100', '250','600'], 800), "There are 3 available motorcycles matching your criteria!")
    })
    it('check spendings wrong input', () => {
        assert.equal(motorcycleRider.otherSpendings([],[],100), "Invalid Information!")
        assert.equal(motorcycleRider.otherSpendings(['helmet'],'engine oil',true), "Invalid Information!")
        assert.equal(motorcycleRider.otherSpendings('helmet',['engine oil'],true), "Invalid Information!")
        assert.equal(motorcycleRider.otherSpendings(['helmet'],true), "Invalid Information!")
        assert.equal(motorcycleRider.otherSpendings(['helmet'],['engine oil']), "Invalid Information!")
    ...
    it('check spendings', () => {
        ...
        assert.equal(motorcycleRider.otherSpendings(['helmet'],[],true), "You spend $180.00 for equipment and consumables with 10% discount!")
        ...
        assert.equal(motorcycleRider.otherSpendings([],['engine oil'],false), "You spend $70.00 for equipment and consumables!")
