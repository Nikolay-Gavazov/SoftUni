...
//Session is preferred when we need to store 'short-term' info
//--Session is safer because is stored on the server
//Cookies are preferred when we need to store 'long-term' info
//--Cookies are not very safe.Expiration can be set, and it can las for years.
